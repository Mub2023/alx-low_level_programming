#include "main.h"
/**
 * checkElf - checks if file is elf
 * @e_ident: a pointer to an array containts the ELF magic numbers
 */
...
/**
 * pmagic - prints the maigice numbers of the ELF header
 * @e_ident: a pointer to an array containts the ELF magic numbers
 */
...
/**
 * pclass - printd the class of an ELF header
 * @e_ident: a pointer to an array containts the ELF magic numbers
 */
...
/**
 * pdata - prints the data of the ELF header.
 * @e_ident: a pointer to an array containts the ELF magic numbers
 */
...
/**
 * pabi - Prints the ABI version of ELF header.
...
/**
 * ptype - print the type of an ELF header.
 * @e_ident: a pointer to an array containts the ELF magic numbers
 * @e_type: the ELF type.
 */
 ...
 * the ELF header at the start of ELF file.
 * @argc: The number of argument enterd
 * @argv: is array of pointer
